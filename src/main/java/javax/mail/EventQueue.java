 ...
 * dispatches events from the queue.
 *
 * @author Bill Shannon
 */
class EventQueue implements Runnable {
	...
	/**
	 * Construct an EventQueue using the specified Executor. If the Executor is
	 * null, threads will be created as needed.
	 */
	...
	/**
	 * Create (if necessary) an application-scoped event queue. Application scoping
	 * is based on the thread's context class loader.
	 */
