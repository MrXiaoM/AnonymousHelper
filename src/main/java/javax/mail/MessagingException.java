...
public class MessagingException extends Exception {
	...
	/**
	 * Add an exception to the end of the chain. If the end is <strong>not</strong>
	 * a MessagingException, this exception cannot be added to the end.
	 *
	...
	/**
	 * Return the "toString" information for this exception, without any information
	 * on nested exceptions.
	 */
