...
public interface MimePart extends Part {
	...
	/**
	 * Get the values of all header fields available for this header, returned as a
	 * single String, with the values separated by the delimiter. If the delimiter
	 * is <code>null</code>, only the first value is returned.
	 *
