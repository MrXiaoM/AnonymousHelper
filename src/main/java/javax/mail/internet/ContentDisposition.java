...
public class ContentDisposition {
	...
	/**
	 * Constructor that takes a ContentDisposition string. The String is parsed into
	 * its constituents: dispostion and parameters. A ParseException is thrown if
	 * the parse fails.
	 *
	 ...
	 * Returns an empty string if the conversion failed.
	 *
