...
class UniqueValue {
	...
	public static String getUniqueBoundaryValue() {
		...
		s.append("----=_Part_").append(id.getAndIncrement()).append("_").append(hash).append('.')
	 ...
	 *
	 * This implementation generates it by concatenating a newly created object's
	 * <code>hashCode()</code>, a global ID (incremented on every use), the current
	 * time (in milliseconds), and the host name from this user's local address
	 * generated by <code>InternetAddress.getLocalAddress()</code>. (The host name
	 * defaults to "localhost" if <code>getLocalAddress()</code> returns null.)
	 *
	...
	public static String getUniqueMessageIDValue(Session ssn) {
		...
		s.append(s.hashCode()).append('.').append(id.getAndIncrement()).append('.').append(System.currentTimeMillis())
				.append(suffix);
		return s.toString();
	}
}
