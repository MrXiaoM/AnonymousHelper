...
/**
 * This class represents a MIME Content-Type value. It provides methods to parse
 * a Content-Type string into individual components and to generate a MIME style
 * Content-Type string.
 *
 * @author John Mani
 */
...
public class ContentType {
	 ...
	 * constituents: primaryType, subType and parameters. A ParseException is thrown
	 * if the parse fails.
	 *
	...
	/**
	 * Set the specified parameter. If this parameter already exists, it is replaced
	 * by this new value.
	 *
	...
	/**
	 * Retrieve a RFC2045 style string representation of this Content-Type. Returns
	 * an empty string if the conversion failed.
	 *
	 ...
	 * <strong>only the <code>primaryType</code> and <code>subType</code> </strong>.
	 * The parameters of both operands are ignored.
	 * <p>
	 *
	 * For example, this method will return <code>true</code> when comparing the
	 * ContentTypes for <strong>"text/plain"</strong> and <strong>"text/plain;
	 * charset=foobar"</strong>.
	 *
	 * If the <code>subType</code> of either operand is the special character '*',
	 * then the subtype is ignored during the match. For example, this method will
	 * return <code>true</code> when comparing the ContentTypes for
	 * <strong>"text/plain"</strong> and <strong>"text/*" </strong>
	 *
	 ...
	 *
	 * For example, this method will return <code>true</code> when comparing the
	 * ContentType for <strong>"text/plain"</strong> with <strong>"text/plain;
	 * charset=foobar"</strong>.
	 *
	 * If the <code>subType</code> of either operand is the special character '*',
	 * then the subtype is ignored during the match. For example, this method will
	 * return <code>true</code> when comparing the ContentType for
	 * <strong>"text/plain"</strong> with <strong>"text/*" </strong>
	 *
