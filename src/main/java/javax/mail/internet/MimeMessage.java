...
public class MimeMessage extends Message implements MimePart {
	 ...
	 * <code>saveChanges</code> method. The <code>writeTo</code> method checks this
	 * flag and calls the <code>saveChanges</code> method as necessary. This avoids
	 * the common mistake of forgetting to call the <code>saveChanges</code> method
	 * on a newly constructed message.
	 *
	 * @since JavaMail 1.2
	 */
	...
	/**
	 * If our content is a Multipart or Message object, we save it the first time
	 * it's created by parsing a stream so that changes to the contained objects
	 * will not be lost.
	 * <p>
	 *
	 * If this field is not null, it's return by the {@link #getContent} method. The
	 * {@link #getContent} method sets this field if it would return a Multipart or
	 * MimeMessage object. This field is is cleared by the {@link #setDataHandler}
	 * method.
	 *
	 * @since JavaMail 1.5
	 */
	 ...
	 * <p>
	 *
	 * Note: The current implementation is rather inefficient, copying the data more
	 ...
	 * is absent, the "Sender" header field is used. If the "Sender" header field is
	 * also absent, <code>null</code> is returned.
	 * <p>
	 *
	 ...
	 * @exception IllegalStateException if this message is obtained from a READ_ONLY
	 *                                  folder.
	...
	/**
	 * Set the RFC 822 "From" header field. Any existing values are replaced with
	 * the given addresses. If address is <code>null</code>, this header is removed.
	 *
	...
	/**
	 * Add the specified addresses to the existing "From" field. If the "From" field
	...
	/**
	 * Set the RFC 822 "Sender" header field. Any existing values are replaced with
	 * the given address. If address is <code>null</code>, this header is removed.
	 *
	 * @param address the sender of this message
	 * @exception IllegalWriteException if the underlying implementation does not
	 ...
	 * additional RecipientTypes. The one additional RecipientType currently defined
	 * here is NEWSGROUPS.
	 *
	 ...
	 * <br>
	 *
	 * Returns null if the header specified by the type is not found or if its value
	 * is empty.
	 * <p>
	 *
	 * This implementation uses the <code>getHeader</code> method to obtain the
	 ...
	 * @exception MessagingException if header could not be retrieved
	 ...
	 * parameter is <code>null</code>, the corresponding recipient field is removed.
	 *
	 ...
	 * @param type      Recipient type
	 * @param addresses Addresses
	 * @exception AddressException      if the attempt to parse the addresses String
	 *                                  fails
	 * @exception IllegalWriteException if the underlying implementation does not
	 *                                  support modification of existing values
	 * @exception IllegalStateException if this message is obtained from a READ_ONLY
	...
	/**
	 * Returns the value of the "Subject" header field. Returns null if the subject
	 * field is unavailable or its value is absent.
	 * <p>
	 *
	 * If the subject is encoded as per RFC 2047, it is decoded and converted into
	 * Unicode. If the decoding or conversion fails, the raw data is returned as is.
	 * <p>
	 *
	 * This implementation uses the <code>getHeader</code> method to obtain the
	 * requisite header field.
	 ...
	 * subject contains only US-ASCII characters, no encoding is done and it is used
	 * as-is. If the subject is null, the existing "Subject" field is removed.
	 * <p>
	 *
	 ...
	 * contains only US-ASCII characters, no encoding is done and it is used as-is.
	 * If the subject is null, the existing "Subject" header field is removed.
	 * <p>
	 *
	 * The application must ensure that the subject does not contain any line
	 * breaks.
	...
	/**
	 * Returns the value of the RFC 822 "Date" field. This is the date on which this
	 * message was sent. Returns null if this field is unavailable or its value is
	 * absent.
	 * <p>
	 * 
	 * This implementation uses the <code>getHeader</code> method to obtain the
	...
	/**
	 * Set the RFC 822 "Date" header field. This is the date on which the creator of
	 * the message indicates that the message is complete and ready for delivery. If
	 * the date parameter is <code>null</code>, the existing "Date" field is
	 * removed.
	 *
	 * @exception IllegalWriteException if the underlying implementation does not
	 ...
	 * <p>
	 *
	 * Note that this number may not be an exact measure of the content size and may
	 * or may not account for any transfer encoding of the content.
	 * <p>
	 *
	...
	/**
	 * Return the number of lines for the content of this message. Return -1 if this
	...
	/**
	 * Returns the value of the RFC 822 "Content-Type" header field. This represents
	 * the content-type of the content of this message. This value must not be null.
	 ...
	 * <p>
	 *
	 * For example, this method will return <code>true</code> when comparing a Part
	 * of content type <strong>"text/plain"</strong> with <strong>"text/plain;
	 * charset=foobar"</strong>.
	 * <p>
	 *
	 * If the <code>subType</code> of <code>mimeType</code> is the special character
	...
	/**
	 * Returns the disposition from the "Content-Disposition" header field. This
	...
	/**
	 * Set the disposition in the "Content-Disposition" header field of this body
	 * part. If the disposition is null, any existing "Content-Disposition" header
	 * field is removed.
	 *
	 * @exception IllegalWriteException if the underlying implementation does not
	 *                                  support modification
	...
	/**
	 * Returns the value of the "Content-ID" header field. Returns <code>null</code>
	...
	/**
	 * Return the value of the "Content-MD5" header field. Returns <code>null</code>
	 ...
	 * and converted into Unicode. If the decoding or conversion fails, the raw data
	 * is returned as-is
	 * <p>
	 *
	 * This implementation uses the <code>getHeader</code> method to obtain the
	 ...
	 * <p>
	 *
	 * If the description contains non US-ASCII characters, it will be encoded using
	 * the platform's default charset. If the description contains only US-ASCII
	 ...
	 * @exception IllegalStateException if this message is obtained from a READ_ONLY
	 *                                  folder.
	 * @exception MessagingException    An UnsupportedEncodingException may be
	 *                                  included in the exception chain if the
	 ...
	 *
	 * If the description contains non US-ASCII characters, it will be encoded using
	 * the specified charset. If the description contains only US-ASCII characters,
	 * no encoding is done and it is used as-is.
	 * <p>
	 *
	 * Note that if the charset encoding process fails, a MessagingException is
	 * thrown, and an UnsupportedEncodingException is included in the chain of
	 ...
	 *
	 * @return Message-ID
	 * @exception MessagingException if the retrieval of this field causes any
	 *                               exception.
	 ...
	 * <p>
	 *
	 * Returns the value of the "filename" parameter from the "Content-Disposition"
	 * header field of this message. If it's not available, returns the value of the
	 * "name" parameter from the "Content-Type" header field of this BodyPart.
	 * Returns <code>null</code> if both are absent.
	 * <p>
	 *
	 * If the <code>mail.mime.encodefilename</code> System property is set to true,
	 * the {@link MimeUtility#decodeText MimeUtility.decodeText} method will be used
	 * to decode the filename. While such encoding is not supported by the MIME
	 * spec, many mailers use this technique to support non-ASCII characters in
	 * filenames. The default value of this property is false.
	 *
	 * @return filename
	 * @exception MessagingException for failures
	 */
	 ...
	 *
	 * If the <code>mail.mime.encodefilename</code> System property is set to true,
	 * the {@link MimeUtility#encodeText MimeUtility.encodeText} method will be used
	 * to encode the filename. While such encoding is not supported by the MIME
	 * spec, many mailers use this technique to support non-ASCII characters in
	 * filenames. The default value of this property is false.
	 *
	 * @exception IllegalWriteException if the underlying implementation does not
	...
	/**
	 * Produce the raw bytes of the content. This method is used during parsing, to
	 * create a DataHandler object for the content. Subclasses that can provide a
	 * separate input stream for just the message content might want to override
	 * this method.
	 * <p>
	 *
	 * This implementation returns a SharedInputStream, if
	 * <code>contentStream</code> is not null. Otherwise, it returns a
	 * ByteArrayInputStream constructed out of the <code>content</code> byte array.
	 *
	 ...
	 * method or <code>getContent</code> method from returning the correct data. In
	 * such a case the application may use this method and attempt to decode the raw
	 * data itself.
	 * <p>
	 *
	 ...
	 * <p>
	 *
	 * The implementation provided here works approximately as follows. Note the use
	 * of the <code>getContentStream</code> method to generate the byte stream for
	...
	/**
	 * Return the content as a Java object. The type of this object is dependent on
	 * the content itself. For example, the native format of a "text/plain" content
	 * is usually a String object. The native format for a "multipart" message is
	...
	public Object getContent() throws IOException, MessagingException {
		...
		if (MimeBodyPart.cacheMultipart && (c instanceof Multipart || c instanceof Message)
				&& (content != null || contentStream != null)) {
			cachedContent = c;
			/*
			 * We may abandon the input stream so make sure the MimeMultipart has consumed
			 * the stream.
			 */
	 ...
	 * <code>setContent(foobar, "application/x-foobar")</code>, a DataContentHandler
	 * for "application/x-foobar" should be installed. Refer to the Java Activation
	 ...
	 * MIME type of "text/plain". If the string contains non US-ASCII characters. it
	 * will be encoded using the platform's default charset. The charset is also
	...
	/**
	 * Convenience method that sets the given String as this part's content, with a
	 * MIME type of "text/plain" and the specified charset. The given Unicode string
	 * will be charset-encoded using the specified charset. The charset is also used
	 * to set the "charset" parameter.
	 *
	 * @param text    the text content to set
	...
	/**
	 * Convenience method that sets the given String as this part's content, with a
	 * primary MIME type of "text" and the specified MIME subtype. The given Unicode
	...
	/**
	 * Get a new Message suitable for a reply to this message. The new Message will
	 * have its attributes and headers set up appropriately. Note that this new
	 * message object will be empty, i.e., it will <strong>not</strong> have a
	 ...
	 * "Re:" (unless it already starts with "Re:"). The "In-Reply-To" header is set
	 * in the new message if this message has a "Message-Id" header. The
	 * <code>ANSWERED</code> flag is set in this message.
	 *
	 * The current implementation also sets the "References" header in the new
	 * message to include the contents of the "References" header (or, if missing,
	 * the "In-Reply-To" header) in this message, plus the contents of the
	 ...
	 * <p>
	 *
	 * If <code>setAnswered</code> is set, the {@link javax.mail.Flags.Flag#ANSWERED
	 * ANSWERED} flag is set in this message.
	 * <p>
	 *
	 * The "Subject" field is filled in with the original subject prefixed with
	 * "Re:" (unless it already starts with "Re:"). The "In-Reply-To" header is set
	 * in the new message if this message has a "Message-Id" header.
	 *
	 * The current implementation also sets the "References" header in the new
	 * message to include the contents of the "References" header (or, if missing,
	 * the "In-Reply-To" header) in this message, plus the contents of the
	...
	public Message reply(boolean replyToAll, boolean setAnswered) throws MessagingException {
		...
		/*
		 * Have to manipulate the raw Subject header so that we don't lose any encoding
		 * information. This is safe because "Re:" isn't internationalized and
		 * (generally) isn't encoded. If the entire Subject header is encoded, prefixing
		 * it with "Re: " still leaves a valid and correct encoded header.
		 */
	 ...
	 * without the duplicates. Add any new addresses to v. Note that the input array
	 * may be modified.
	 */
	 ...
	 * <p>
	 *
	 * Note that, depending on how the messag was constructed, it may use a variety
	 * of line termination conventions. Generally the output should be sent through
	 * an appropriate FilterOutputStream that converts the line terminators to the
	 * desired form, either CRLF for MIME compatibility and for use in Internet
	 * protocols, or the local platform's line terminator for storage in a local
	 * text file.
	 * <p>
	 *
	 ...
	 *
	 * @exception IOException        if an error occurs writing to the stream or if
	...
	/**
	 * Set the value for this header_name. Replaces all existing header values with
	 * this new value. Note that RFC 822 headers must contain only US-ASCII
	 * characters, so a header that contains non US-ASCII characters must have been
	...
	/**
	 * Add this value to the existing values for this header_name. Note that RFC 822
	 * headers must contain only US-ASCII characters, so a header that contains non
	 * US-ASCII characters must have been encoded as per the rules of RFC 2047.
	 *
	 * @param name  header name
	 * @param value header value
	 * @see javax.mail.internet.MimeUtility
	 ...
	 * <p>
	 *
	 * Note that certain headers may be encoded as per RFC 2047 if they contain non
	 ...
	 * objects. This implementation obtains the header from the <code>headers</code>
	 * InternetHeaders object.
	 *
	 * @exception MessagingException for failures
	 */
	...
	/**
	 * Get all header lines as an Enumeration of Strings. A Header line is a raw RFC
	 * 822 header-line, containing both the "name" and "value" field.
	 *
	 * @exception MessagingException for failures
	 */
	@Override
	...
	/**
	 * Get non-matching header lines as an Enumeration of Strings. A Header line is
	 ...
	 * <p>
	 *
	 * Note that a clone of the internal Flags object is returned, so modifying the
	 * returned Flags object will not affect the flags of this message.
	 *
	...
	/**
	 * Check whether the flag specified in the <code>flag</code> argument is set in
	 * this message.
	 * <p>
	 *
	 * This implementation checks this message's internal <code>flags</code> object.
	 *
	 * @param flag the flag
	 ...
	 * the message's contents. If this message is contained in a Folder, any changes
	 * made to this message are committed to the containing folder.
	 * <p>
	 *
	 ...
	 * <code>save</code> flag to true, and then calls the <code>updateHeaders</code>
	 * method.
	 *
	 * @exception IllegalWriteException if the underlying implementation does not
	 *                                  support modification
	 ...
	 * set), the <code>Date</code> header (if not already set), the
	 * <code>MIME-Version</code> header and the <code>Message-ID</code> header.
	 * Also, if the content of this message is a <code>MimeMultipart</code>, its
	 ...
	 * DataHandler, any stream data used to create this object is discarded, and the
	 * {@link #cachedContent} field is cleared.
	 *
	 * @exception IllegalWriteException if the underlying implementation does not
	 *                                  support modification
	 * @exception IllegalStateException if this message is obtained from a READ_ONLY
	...
	/**
	 * Create and return a MimeMessage object. The reply method uses this method to
	 * create the MimeMessage object that it will return. Subclasses can override
	 * this method to return a subclass of MimeMessage. This implementation simply
	 * constructs and returns a MimeMessage object using the supplied Session.
	 *
