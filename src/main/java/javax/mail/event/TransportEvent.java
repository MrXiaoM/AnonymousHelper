...
public class TransportEvent extends MailEvent {
	 ...
	 * firing this event. validSent[] contains all the addresses this transport sent
	 * to successfully. validUnsent[] and invalid[] should be null,
	 */
	public static final int MESSAGE_DELIVERED = 1;

	/**
	 * Message was not sent for some reason. validSent[] should be null.
	 * validUnsent[] may have addresses that are valid (but the message wasn't sent
	 * to them). invalid[] should likely contain invalid addresses.
	 */
	public static final int MESSAGE_NOT_DELIVERED = 2;

	/**
	 * Message was successfully sent to some recipients but not to all. validSent[]
	 * holds addresses of recipients to whom the message was sent. validUnsent[]
	 * holds valid addresses to which the message was not sent. invalid[] holds
	 * invalid addresses, if any.
	 */
	 ...
	 * @param validUnsent the valid addresses to which the message was not sent
	 * @param invalid     the invalid addresses
	 * @param msg         the message being sent
	 */
	public TransportEvent(Transport transport, int type, Address[] validSent, Address[] validUnsent, Address[] invalid,
			Message msg) {
		super(transport);
		this.type = type;
