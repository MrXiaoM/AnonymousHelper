 ...
 * <A HREF="http://www.ietf.org/rfc/rfc3501.txt" TARGET="_top">RFC 3501</A> for
 * details. A client may want to "poll" the folder by occasionally calling the
 * {@link javax.mail.Folder#getMessageCount getMessageCount} or
 * {@link javax.mail.Folder#isOpen isOpen} methods to solicit any such
 * notifications.
 *
 * @author John Mani
 */
...
public class MessageCountEvent extends MailEvent {
	...
	/**
	 * If true, this event is the result of an explicit expunge by this client, and
	 * the messages in this folder have been renumbered to account for this. If
	 * false, this event is the result of an expunge by external sources.
	 *
	 * @serial
	 */
	 ...
	 *                this client, and the messages in this folder have been
	 *                renumbered to account for this. If false, this event is the
	 *                result of an expunge by external sources.
	 *
	 ...
	 * this event is due to an explicit expunge and hence all remaining messages in
	 * this folder have been renumbered. If <code>false</code>, this event is due to
	 * an external expunge.
	 * <p>
	 *
