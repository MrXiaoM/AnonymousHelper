...
public class SharedFileInputStream extends BufferedInputStream implements SharedInputStream {
	...
	/**
	 * A shared class that keeps track of the references to a particular file so it
	 * can be closed when the last reference is gone.
	 */
	...
	/**
	 * Creates a <code>SharedFileInputStream</code> with the specified buffer size.
	 *
	 * @param file the file
...
//	+ " bufpos " + bufpos + " = " + (bufpos + pos - start));
	 ...
	 * <code>end</code> is -1, the new stream ends at the same place as this stream.
