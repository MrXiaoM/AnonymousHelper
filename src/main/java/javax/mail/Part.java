...
public interface Part {
	 ...
	 * <p>
	 *
	 * Note that the size may not be an exact measure of the content size and may or
	 * may not account for any transfer encoding of the content. The size is
	 * appropriate for display in a user interface to give the user a rough idea of
	 ...
	 * considered without regard to case. For example: <blockquote>
	 * 
	 * <pre>
	 ...
	 *                                  support modification of this header
	...
	/**
	 * Get the filename associated with this part, if possible. Useful if this part
	 * represents an "attachment" that was loaded from a file. The filename will
	 * usually be a simple name, not including directory components.
	 *
	...
	/**
	 * Set the filename associated with this part, if possible. Useful if this part
	 * represents an "attachment" that was loaded from a file. The filename will
	 * usually be a simple name, not including directory components.
	 *
	...
	/**
	 * Return an input stream for this part's "content". Any mail-specific transfer
	 * encodings will be decoded before the input stream is provided.
	 * <p>
	 *
	...
	/**
	 * Return a DataHandler for the content within this part. The DataHandler allows
	 * clients to operate on as well as retrieve the content.
	 *
	 ...
	 * course dependent on the content itself. For example, the object returned for
	 * "text/plain" content is usually a String object. The object returned for a
	 ...
	 * <p>
	 *
	 * This is a convenience method that just invokes the DataHandler's getContent()
	 * method
	 *
	 * @return Object
	 * @exception IOException        this is typically thrown by the DataHandler.
	 ...
	 * available to the JavaMail implementation for this to work right. i.e., to do
	...
	/**
	 * A convenience method that sets the given String as this part's content with a
	 ...
	 * <p>
	 *
	 * Classes that implement the Part interface decide on the appropriate encoding
	 ...
	 *                               layer.
	 * @exception MessagingException if an error occurs fetching the data to be
	 *                               written
	 *
