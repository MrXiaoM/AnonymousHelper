 ...
 * items.
 * 
 * To send a message, an appropriate subclass of Message (e.g., MimeMessage) is
 * instantiated, the attributes and content are filled in, and the message is
 * sent using the <code>Transport.send</code> method.
 * <p>
 *
 * @author John Mani
 * @author Bill Shannon
...
public abstract class Message implements Part {
	...
	/**
	 * The number of this message within its folder, or zero if the message was not
	 ...
	 * class. The currently defined types are TO, CC and BCC.
	 *
	 * Note that this class only has a protected constructor, thereby restricting
	 * new Recipient types to either this class or subclasses. This effectively
	 * implements an enumeration of the allowed Recipient types.
	 *
	 * The following code sample shows how to use this class to obtain the "TO"
	 * recipients from a message. <blockquote>
	 * 
	 * <pre>
	 *
	...
	public static class RecipientType implements Serializable {
		...
		/**
		 * The type of recipient, usually the name of a corresponding Internet standard
		 * header.
		 *
		 * @serial
		 */
		...
		/**
		 * When deserializing a RecipientType, we need to make sure to return only one
		 * of the known static final instances defined in this class. Subclasses must
		 * implement their own <code>readResolve</code> method that checks for their
		 * known instances before calling this super method.
		 *
	 ...
	 * <p>
	 *
	 * This method returns <code>null</code> if no recipients of the given type are
	 * present in this message. It may return an empty array if the header is
	 ...
	 * extracts the TO, CC, and BCC recipients using the <code>getRecipients</code>
	 * method.
	 * <p>
	 *
	 * This method returns <code>null</code> if none of the recipient headers are
	 * present in this message. It may Return an empty array if any recipient header
	...
	/**
	 * Set the recipient addresses. All addresses of the specified type are replaced
	 * by the addresses parameter.
	 *
	 * @param type      the recipient type
	 ...
	 *                                        READ_ONLY folder.
	 * @exception MethodNotSupportedException if the underlying implementation does
	 ...
	 * <p>
	 *
	 * Modifying any of the flags in this returned Flags object will not affect the
	 * flags of this message. Use <code>setFlags()</code> to do that.
	 * <p>
	 *
	...
	/**
	 * Set the specified flags on this message to the specified value. Note that any
	 * flags in this message that are not specified in the given <code>Flags</code>
	 * object are unaffected.
	 * <p>
	 *
	 * This will result in a <code>MessageChangedEvent</code> being delivered to any
	...
	/**
	 * Get the Message number for this Message. A Message object's message number is
	 * the relative position of this Message in its Folder. Note that the message
	 * number for a particular Message can change during a session if other messages
	 * in the Folder are deleted and expunged.
	 * <p>
	 *
	...
	/**
	 * Get the folder from which this message was obtained. If this is a new message
	 * or nested message, this method returns null.
	 *
	 ...
	 * message object will be empty, that is, it will <strong>not</strong> have a
