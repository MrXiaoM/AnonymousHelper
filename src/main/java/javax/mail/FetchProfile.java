...
public class FetchProfile {
	 ...
	 * <code>CONTENT_INFO</code> and <code>FLAGS</code>. The <code>UIDFolder</code>
	 * interface defines the <code>UID</code> Item as well.
	 * <p>
	 *
	 * Note that this class only has a protected constructor, therby restricting new
	 * Item types to either this class or subclasses. This effectively implements a
	 * enumeration of allowed Item types.
	 *
	 * @see UIDFolder
	 */
	...
	public static class Item {
		 ...
		 * Implementations should include the following attributes: From, To, Cc, Bcc,
		 * ReplyTo, Subject and Date. More items may be included as well.
		 * <p>
		 *
		 ...
		 * <p>
		 *
		 * This includes all the attributes that describe the content of the message.
		 * Implementations should include the following attributes: ContentType,
		 * ContentDisposition, ContentDescription, Size and LineCount. Other items may
		 * be included as well.
		 */
		 ...
		 * indicates that the sizes of the messages in the specified range should be
		 * prefetched.
		 * <p>
		 *
		 * @since JavaMail 1.5
