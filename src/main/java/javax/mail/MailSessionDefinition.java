 ...
 * to be registered with JNDI. The <code>MailSession</code> may be configured by
 * setting the annotation elements for commonly used <code>Session</code>
 ...
 * <code>Java EE</code> namespace, and will determine the accessibility of the
 * session from other components.
 *
 * @since JavaMail 1.5
 */
...
public @interface MailSessionDefinition {
	...
	/**
	 * Properties to include in the Session. Properties are specified using the
	 * format: <i>propertyName=propertyValue</i> with one property per array
	 * element.
	 *
