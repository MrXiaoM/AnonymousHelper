...
public class SendFailedException extends MessagingException {
	...
	/**
	 * Constructs a SendFailedException with the specified string and the specified
	 * address objects.
	 *
	 ...
	 * @see #setNextException
	 */
	public SendFailedException(String msg, Exception ex, Address[] validSent, Address[] validUnsent,
			Address[] invalid) {
		super(msg, ex);
