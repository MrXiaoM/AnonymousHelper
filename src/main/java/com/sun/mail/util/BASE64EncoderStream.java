...
public class BASE64EncoderStream extends FilterOutputStream {
	 ...
	 * @param bytesPerLine number of bytes per line. The encoder inserts a CRLF
	 *                     sequence after the specified number of bytes, unless
	 *                     bytesPerLine is Integer.MAX_VALUE, in which case no CRLF
	 *                     is inserted. bytesPerLine is rounded down to a multiple
	 *                     of 4.
	 */
	...
	/**
	 * Create a BASE64 encoder that encodes the specified input stream. Inserts the
	...
	/**
	 * Flushes this output stream and forces any buffered output bytes to be encoded
	 * out to the stream.
	 *
	 * @exception IOException if an I/O error occurs.
	 */
	 ...
	 * FileInputStream infile = new FileInputStream(argv[0]); BASE64EncoderStream
	 * encoder = new BASE64EncoderStream(System.out); int c;
	 * 
