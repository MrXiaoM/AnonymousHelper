...
public class QPEncoderStream extends FilterOutputStream {
	 ...
	 * @param bytesPerLine the number of bytes per line. The encoder inserts a CRLF
	...
	/**
	 * Create a QP encoder that encodes the specified input stream. Inserts the CRLF
	 * sequence after outputting 76 bytes.
	 * 
	 * @param out the output stream
	 */
