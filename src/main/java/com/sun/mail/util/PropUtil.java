...
/**
 * Utilities to make it easier to get property values. Properties can be strings
 * or type-specific value objects.
 *
 * @author Bill Shannon
 */
public class PropUtil {
	...
	public static boolean getBooleanSystemProperty(String name, boolean def) {
		...
		/*
		 * If we can't get the entire System Properties object because of a
		 * SecurityException, just ask for the specific property.
		 */
		try {
	...
	/**
	 * Get the value of the specified property. If the "get" method returns null,
	 * use the getProperty method, which might cascade to a default Properties
	 * object.
	 */
	...
	private static boolean getBoolean(Object value, boolean def) {
		...
		if (value instanceof String) {
			/*
			 * If the default is true, only "false" turns it off. If the default is false,
