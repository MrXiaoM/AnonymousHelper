 ...
 * Note that the MIME stream will include both the headers and the body of the
 * message or part. This should be the same data that is produced by the writeTo
 * method, but in a readable form.
 *
 * @author Bill Shannon
