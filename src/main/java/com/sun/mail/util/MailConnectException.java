 ...
 * Unlike java.net.ConnectException, it includes details of what we were trying
 * to connect to. The underlying exception is available as the "cause" of this
 * exception.
 *
...
public class MailConnectException extends MessagingException {
	...
	public MailConnectException(SocketConnectException cex) {
		super("Couldn't connect to host, port: " + cex.getHost() + ", " + cex.getPort() + "; timeout "
				+ cex.getConnectionTimeout() + (cex.getMessage() != null ? ("; " + cex.getMessage()) : ""));
