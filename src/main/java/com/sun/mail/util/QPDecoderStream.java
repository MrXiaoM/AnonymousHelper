...
public class QPDecoderStream extends FilterInputStream {
	...
	public int read() throws IOException {
		...
		if (c == ' ') {
			...
			if (a == '\n') {
				/*
				 * Hmm ... not really confirming QP encoding, but lets allow this as a LF
				 * terminated encoded line .. and consider this a soft linebreak and recurse to
				 * fetch the next char.
				 */
				return read();
			} else if (a == '\r') {
	 ...
	 * decoder = new QPDecoderStream(infile); int c;
	 * 
