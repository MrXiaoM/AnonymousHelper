...
public class DurationFilter implements Filter {
	...
	/**
	 * The duration in milliseconds used to determine the rate. The duration is also
	 * used as the amount of time that the filter will not allow records when
	 * saturated.
	 */
	private final long duration;
	/**
	 * The number of records seen for the current duration. This value negative if
	 * saturated. Zero is considered saturated but is reserved for recording the
	 * first duration.
	 */
	private long count;
	/**
	...
	/**
	 * Creates the filter using the given properties. Default values are used if any
	 * of the given values are outside the allowed range.
	 *
	 * @param records  the number of records per duration.
	 * @param duration the number of milliseconds to suppress log records from being
	 *                 published.
	 */
	...
	/**
	 * Determines if this filter is able to accept the maximum number of log records
	 * for this instant in time. The result is a best-effort estimate and should be
	 * considered out of date as soon as it is produced. This method is designed for
	 * use in monitoring the state of this filter.
	 *
	...
	/**
	 * Check if the given log record should be published. This method will modify
	 * the internal state of this filter.
	 *
	 ...
	 * The result is a best-effort estimate and should be considered out of date as
	 * soon as it is produced. This method is designed for use in monitoring the
	...
	/**
	 * Returns a string representation of this filter. The result is a best-effort
	 * estimate and should be considered out of date as soon as it is produced.
	 *
	...
	public String toString() {
		...
		return getClass().getName() + "{records=" + records + ", duration=" + duration + ", idle=" + idle
				+ ", loggable=" + loggable + '}';
	}

	/**
	 * Creates a copy of this filter that retains the filter settings but does not
	 * include the current filter state. The newly create clone acts as if it has
	 * never seen any records.
	 *
	...
	/**
	 * Reads a long value or multiplication expression from the LogManager. If the
	 * value can not be parsed or is not defined then Long.MIN_VALUE is returned.
	 *
	...
	/**
	 * Determines if the given suffix can be a time unit and the value is encoded as
	 * an ISO ISO-8601 duration format.
	 *
	...
	/**
	 * Converts record count to a valid record count. If the value is out of bounds
	 * then the default record count is used.
	 *
	...
	/**
	 * Converts the duration to a valid duration. If the value is out of bounds then
