 ...
 * <ol>
 * <li>The natural comparison of the LogRecord {@linkplain Level#intValue
 * level}.
 ...
 * <li>The natural comparison of the LogRecord {@linkplain LogRecord#getMillis()
 * millis}.
 * </ol>
 *
...
public class SeverityComparator implements Comparator<LogRecord>, Serializable {
	...
	/**
	 * A single instance that is shared among the logging package. The field is
	 * declared as java.util.Comparator so
	...
	/**
	 * Identifies a single throwable that best describes the given throwable and the
	 * entire {@linkplain Throwable#getCause() cause} chain. This method can be
	 * overridden to change the behavior of
	 * {@link #compare(java.util.logging.LogRecord, java.util.logging.LogRecord)}.
	 *
	 * @param chain the throwable or null.
	 * @return null if null was given, otherwise the throwable that best describes
	 *         the entire chain.
	 ...
	 * {@link #apply(java.lang.Throwable) reduce} each argument before comparing.
	 * This is method can be overridden to change the behavior of
	...
	/**
	 * Determines if the given object is also a comparator and it imposes the same
	...
	/**
	 * Determines if the given throwable instance is "normal occurrence". This is
	 * any checked or unchecked exception with 'Interrupt' in the class name or
	 * ancestral class name. Any {@code java.lang.ThreadDeath} object or subclasses.
	 *
