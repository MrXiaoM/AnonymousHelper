...
/**
 * An SSL socket factory that makes it easier to specify trust. This socket
 * factory can be configured to trust all hosts or trust a specific set of
 * hosts, in which case the server's certificate isn't verified. Alternatively,
...
public class MailSSLSocketFactory extends SSLSocketFactory {
	...
	/**
	 * Initializes a new MailSSLSocketFactory with a given protocol. Normally the
	 * protocol will be specified as "TLS".
	 * 
	...
	/**
	 * Gets an SSLSocketFactory based on the given (or default) KeyManager array,
	 * TrustManager array and SecureRandom and sets it to the instance var
	 * adapteeFactory.
	 *
	...
	/**
	 * After a successful conection to the server, this method is called to ensure
	 * that the server should be trusted.
	 * 
	 * @param server    name of the server we connected to
	 * @param sslSocket SSLSocket connected to the server
	 * @return true if "trustAllHosts" is set to true OR the server is contained in
	 *         the "trustedHosts" array;
	 */
