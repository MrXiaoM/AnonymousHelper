 ...
 *
 * @see <a href="http://tools.ietf.org/html/rfc6749"> RFC 6749 - OAuth 2.0
 *      Authorization Framework</a>
 * @see <a href="http://tools.ietf.org/html/rfc6750"> RFC 6750 - OAuth 2.0
...
public class OAuth2SaslClient implements SaslClient {
	...
	public byte[] evaluateChallenge(byte[] challenge) throws SaslException {
		...
		/*
		 * The OAuth token isn't really a password, and JavaMail doesn't use char[] for
		 * passwords, so we don't worry about storing the token in strings.
		 */
