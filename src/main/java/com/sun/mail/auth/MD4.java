...
/**
 * The MD4 class is used to compute an MD4 message digest over a given buffer of
 * bytes. It is an implementation of the RSA Data Security Inc MD4 algorithim as
 * described in internet RFC 1320.
 *
...
public final class MD4 {
	 ...
	 * the count is added to the digest, and the resulting digest is stored.
	 */
	...
	/**
	 * This is where the functions come together as the generic MD4 transformation
	 * operation. It consumes 64 bytes from the buffer, beginning at the specified
	 * offset.
	 */
