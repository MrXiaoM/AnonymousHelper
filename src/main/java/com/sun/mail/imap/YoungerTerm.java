...
/**
 * Find messages that are younger than a given interval (in seconds). Relies on
 * the server implementing the WITHIN search extension
...
public final class YoungerTerm extends SearchTerm {
	 ...
	 * The match method.
	 *
	 * @param msg the date comparator is applied to this Message's received date
	...
	public boolean match(Message msg) {
		...
		return d.getTime() >= System.currentTimeMillis() - ((long) interval * 1000);
	}
