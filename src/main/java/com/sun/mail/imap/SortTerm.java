 ...
 * <A HREF="http://www.ietf.org/rfc/rfc5256.txt">RFC 5256</A>. Sort criteria are
 * used with the {@link IMAPFolder#getSortedMessages getSortedMessages} method.
 * Multiple sort criteria are specified in an array with the order in the array
 * specifying the order in which the sort criteria are applied.
 *
...
public final class SortTerm {
	...
	/**
	 * Sort by the base subject text. Note that the "base subject" is defined by RFC
	 * 5256 and doesn't include items such as "Re:" in the subject header.
	 */
