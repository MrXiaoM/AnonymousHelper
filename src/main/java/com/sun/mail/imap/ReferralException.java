...
/**
 * A special kind of AuthenticationFailedException that indicates that the
 * reason for the failure was an IMAP REFERRAL in the response code. See
 * <a href="http://www.ietf.org/rfc/rfc2221.txt">RFC 2221</a> for details.
 *
