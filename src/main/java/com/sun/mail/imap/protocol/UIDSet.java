...
public class UIDSet {
	...
	/**
	 * Convert an array of UIDSets into a array of long UIDs. Don't include any UIDs
	 * larger than uidmax.
	 *
	 * @param uidset the UIDSets
	...
	/**
	 * Count the total number of elements in an array of UIDSets. Don't count UIDs
	 * greater then uidmax.
	 *
	 * @since JavaMail 1.5.1
	 */
