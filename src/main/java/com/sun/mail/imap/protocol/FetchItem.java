...
/**
 * Metadata describing a FETCH item. Note that the "name" field MUST be in
 * uppercase.
 * <p>
 *
 * @author Bill Shannon
...
public abstract class FetchItem {
	...
	/**
	 * Parse the item into some kind of object appropriate for the item. Note that
	 * the item name will have been parsed and skipped already.
	 *
