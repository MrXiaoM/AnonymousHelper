...
public class MailboxInfo {
	...
	/**
	 * Collect the information about this mailbox from the responses to a SELECT or
	 * EXAMINE.
	 *
	...
	public MailboxInfo(Response[] r) throws ParsingException {
		for (int i = 0; i < r.length; i++) {
			...
			if (ir.keyEquals("EXISTS")) {
				 ...
				 * [PERMANENTFLAGS (\Deleted)] * OK [UIDNEXT 44] * OK [HIGHESTMODSEQ 103]
				 */
				ir.skipSpaces();
				...
				/*
				 * should be one of: * NO [UIDNOTSTICKY]
				 */
				ir.skipSpaces();
		...
		/*
		 * The PERMANENTFLAGS response code is optional, and if not present implies that
		 * all flags in the required FLAGS response can be changed permanently.
		 */
