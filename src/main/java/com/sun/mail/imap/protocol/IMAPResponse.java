...
public class IMAPResponse extends Response {
	...
	/**
	 * Read a list of space-separated "flag-extension" sequences and return the list
	 * as a array of Strings. An empty list is returned as null. Each item is
	 * expected to be an atom, possibly preceeded by a backslash, but we aren't that
	 * strict; we just look for strings separated by spaces and terminated by a
	 * right paren. We assume items are always ASCII.
	 *
