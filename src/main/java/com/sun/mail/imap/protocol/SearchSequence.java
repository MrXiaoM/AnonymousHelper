 ...
 * search sequence.
 *
 * Each IMAPProtocol instance contains an instance of this class, which might be
 * subclassed by subclasses of IMAPProtocol to add support for additional
...
public class SearchSequence {
	...
	/**
	 * Check if any of the "text" terms in the given SearchTerms contain non
	 * US-ASCII characters.
	 *
	...
	protected Argument or(OrTerm term, String charset) throws SearchException, IOException {
		...
		/*
		 * If this term is an AND expression, we need to enclose it within paranthesis.
		 *
	 ...
	 */
	private static String monthTable[] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov",
			"Dec" };
