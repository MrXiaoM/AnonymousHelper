...
public class Rights implements Cloneable {
	...
	public static final class Right {
		...
		/**
		 * Read - SELECT the mailbox, perform CHECK, FETCH, PARTIAL, SEARCH, COPY from
		 * mailbox
		 */
	 ...
	 * @return true if all rights in the given Rights object are present, otherwise
	 *         false.
	 */
	...
	/**
	 * Return all the rights in this Rights object. Returns an array of size zero if
	 * no rights are set.
	 *
	 ...
	 * 
	 * // check copy constructor Rights fc = new Rights(f1); if (f1.equals(fc) &&
	 * fc.equals(f1)) System.out.println("success"); else
	 * System.out.println("fail");
	 * 
	 * // check clone fc = (Rights)f1.clone(); if (f1.equals(fc) && fc.equals(f1))
	 ...
	 * System.out.println("success"); else System.out.println("fail");
	 * 
	 * // check copy constructor fc = new Rights(f1); if (f1.equals(fc) &&
	 * fc.equals(f1)) System.out.println("success"); else
	 * System.out.println("fail");
	 * 
	 * // another new rights object Rights f2 = new Rights(Rights.Right.READ);
	 * f2.add(Rights.Right.WRITE);
	 * 
	 * if (f1.contains(Rights.Right.READ)) System.out.println("success"); else
	 * System.out.println("fail");
	 * 
	 * if (f1.contains(Rights.Right.WRITE)) System.out.println("success"); else
	 * System.out.println("fail");
	 * 
	 * if (f1.contains(Rights.Right.CREATE)) System.out.println("success"); else
	 * System.out.println("fail");
	 * 
	 * if (f1.contains(Rights.Right.DELETE)) System.out.println("success"); else
	 * System.out.println("fail");
	 * 
	 * if (f2.contains(Rights.Right.WRITE)) System.out.println("success"); else
	 * System.out.println("fail");
	 * 
	 * 
	 * System.out.println("----------------");
	 * 
	 * Right[] r = f1.getRights(); for (int i = 0; i < r.length; i++)
	 * System.out.println(r[i]); System.out.println("----------------");
	 * 
	 ...
	 * else System.out.println("fail");
	 * 
	 * Rights f3 = new Rights(); f3.add(Rights.Right.READ);
	 * f3.add(Rights.Right.WRITE); f3.add(Rights.Right.CREATE);
	 * f3.add(Rights.Right.DELETE); f3.add(Rights.Right.ADMINISTER);
