...
public class SMTPSendFailedException extends SendFailedException {
	 ...
	 */
	public SMTPSendFailedException(String cmd, int rc, String err, Exception ex, Address[] vs, Address[] vus,
			Address[] inv) {
	...
	/**
	 * Return the return code from the SMTP server that indicates the reason for the
	 * failure. See <A HREF="http://www.ietf.org/rfc/rfc821.txt">RFC 821</A> for
