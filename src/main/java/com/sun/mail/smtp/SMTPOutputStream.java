...
public class SMTPOutputStream extends CRLFOutputStream {
	 ...
	 * want to flush data out to the socket until we've also written the terminating
	 * "\r\n.\r\n".
	 *
	 * We buffer nothing so there's nothing to flush. We depend on the fact that
	 * CRLFOutputStream also buffers nothing. SMTPTransport will manually flush the
	 * socket before reading the response.
	 */
	@Override
	public void flush() {
		// do nothing
