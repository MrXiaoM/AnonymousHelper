...
public class SMTPMessage extends MimeMessage {
	...
	/**
	 * Constructs an SMTPMessage by reading and parsing the data from the specified
	 ...
	 * envelope From address is typically used when reporting errors. See
	 * <A HREF="http://www.ietf.org/rfc/rfc821.txt">RFC 821</A> for details.
	 * <p>
	 *
	...
	/**
	 * Return notification options as an RFC 1891 string. Returns null if no options
	 * set.
	 */
	String getDSNNotify() {
		if (notifyOptions == 0)
	...
	/**
	 * Set return option to be used if server supports Delivery Status Notification
	 * (<A HREF="http://www.ietf.org/rfc/rfc1891.txt">RFC 1891</A>). Either
	 * <code>RETURN_FULL</code> or <code>RETURN_HDRS</code>.
	 * <p>
	 *
	 ...
	 * this message that use the "quoted-printable" or "base64" encodings are
	 ...
	 * will typically not set a submitter. See
	 * <A HREF="http://www.ietf.org/rfc/rfc2554.txt">RFC 2554</A> for details.
	 *
	 ...
	 * to verify that the server supports the desired service extension. See
	 * <A HREF="http://www.ietf.org/rfc/rfc1869.txt">RFC 1869</A> and other RFCs
