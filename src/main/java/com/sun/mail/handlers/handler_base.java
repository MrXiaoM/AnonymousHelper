...
public abstract class handler_base implements DataContentHandler {
	...
	/**
	 * Return an array of ActivationDataFlavors that we support. Usually there will
	 * be only one.
	 */
	protected abstract ActivationDataFlavor[] getDataFlavors();

	/**
	 * Given the flavor that matched, return the appropriate type of object. Usually
	 * there's only one flavor so just call getContent.
	 */
